...
class HoChiMinhRestaurant extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
        ...
        <Container className="section-container">
          <Grid className="section-header home-container">
            <Grid className="section-header-title">
              Nhà hàng tại TP. Hồ Chí Minh
            </Grid>
            <Grid className="section-header-text">
              Tổng hợp những nhà hàng nổi tiếng tại Thành phố Hồ Chí Minh
            </Grid>
          </Grid>
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(HoChiMinhRestaurant)
);
